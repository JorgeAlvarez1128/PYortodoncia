...
const Login = () => {
  ...
  <img src={Logo} alt="Ortodoncia The Arsenal" />
  <span className="login-badge">Ortodoncia The Arsenal</span>
  <h2>Iniciar sesión</h2>
  <p className="login-subtitle">
    Accede a la gestión de turnos, evolución clínica, inventario y reportes.
  </p>
