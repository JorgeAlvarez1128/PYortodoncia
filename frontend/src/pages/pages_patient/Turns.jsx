        ...
        <div className="turns">
          <div className="information">
            ...
            <p className="initial-information">
              En En Ortodoncia The Arsenal trabajamos para brindarte una atención organizada, precisa y confiable. Conoce los
            ...
            <div className="contact">
              ...
              <div className="contact_frame">
                <a href="mailto:contacto@ortodonciathearsenal.com">
                  <div className="detail-image">
          ...
          <div className="information">
            ...
            <p className="initial-information">
              Durante tu tratamiento en Ortodoncia The Arsenal nos aseguraremos de brindarte
