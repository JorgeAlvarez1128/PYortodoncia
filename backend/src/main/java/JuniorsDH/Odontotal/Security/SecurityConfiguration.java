...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
       http
               ...
               .antMatchers("/insumos/**").hasAnyAuthority("ADMIN", "ODONTOLOGY")
               .antMatchers("/consumos-insumos/**").hasAnyAuthority("ADMIN", "ODONTOLOGY")
               .antMatchers("/evoluciones-clinicas/**").hasAnyAuthority("ADMIN", "ODONTOLOGY")
